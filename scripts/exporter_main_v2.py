...
flags.DEFINE_string('pipeline_config_path', '../my_model/pipeline.config',
                    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
                    'file.')
flags.DEFINE_string('trained_checkpoint_dir', '../my_model/training/',
                    'Path to trained checkpoint directory')
flags.DEFINE_string('output_directory', '../my_model/', 'Path to write outputs.')
