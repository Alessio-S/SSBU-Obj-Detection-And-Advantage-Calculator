...
parser.add_argument("--MP4Path", type = pathlib.Path)
parser.add_argument("--OutputDir", type = pathlib.Path)
parser.add_argument("--ImgInterval", type = float)
args = parser.parse_args()

cap = cv2.VideoCapture(str(args.MP4Path))
