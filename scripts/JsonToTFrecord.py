...
# labelmap = label_map_util.load_labelmap('./bboxredo/utils/label_map.pbtxt')
labelmap = label_map_util.get_label_map_dict('./bboxredo/utils/label_map.pbtxt')
...
# Change this to test the tfrecord
print(sum(1 for _ in tf.data.TFRecordDataset("./tfrecords/ProtoBanham_vs_Kola_val.tfrecord")))
print(sum(1 for _ in tf.data.TFRecordDataset("./tfrecords/ProtoBanham_vs_Kola_train.tfrecord")))
